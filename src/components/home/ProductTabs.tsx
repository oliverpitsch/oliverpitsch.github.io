...
export default function ProductTabs({ products }: { products: Product[] }) {
  ...
  return (
    <div className="group/tabs mt-12 grid gap-6 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:gap-10">
      {/* ---------------- Tabs ---------------- */}
      <div
        ref={listRef}
        role="tablist"
      ...
      <div
        ...
        className="rounded-[28px] border border-line bg-surface p-7 shadow-card sm:p-10"
      >
